...
#  temperature = float(((t_fine * 5) + 128) >> 8)
  temperature = float(((t_fine * 5) + 640) >> 8)
...
#  humidity = humidity * (1.0 - dig_H1 * humidity / 524288.0)
  humidity = humidity * (1.0 - dig_H1 * humidity / 30000.0)  # further adjustment to bring humidity readings in line with multiple nearby stations
  preHum = humidity
